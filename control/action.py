...
class PluginRun:
    ...
    def chrispl_onCUBEargs(self) -> dict[str, str]:
        '''
        Return a dictionary specifying the CUBE instance
        '''
        return {
    ...
    def chrispl_run_cmd(self, str_inputData : str) -> dict:
        '''
        Return the CLI for the chrispl_run in a single member dictionary
        '''
